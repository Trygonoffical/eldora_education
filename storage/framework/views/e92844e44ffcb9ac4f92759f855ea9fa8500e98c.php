                            ...
                            <div class="media">
                                <div class="media-head me-2">
                                    <div class="avatar avatar-primary avatar-sm avatar-rounded">
                                        <span class="initial-wrap text-uppercase"><?php echo e($iname); ?></span>
                                    </div>
                                </div>
                                <div class="media-body">
                                    <div class="dropdown">
                                        
                                        <a id="navbarDropdown" class="d-block  link-dark fw-medium" href="#" role="button"  aria-haspopup="true" aria-expanded="false" v-pre>
...
<!-- /Top Navbar --><?php /**PATH C:\wamp64\www\Eldora\resources\views/inc/dashboardNavbar.blade.php ENDPATH**/ ?>