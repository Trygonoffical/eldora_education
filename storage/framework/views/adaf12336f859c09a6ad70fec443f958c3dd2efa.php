                        ...
                        <li class="nav-item">
                            ...
                            <ul id="dash_records" class="nav flex-column collapse  nav-children">
                                <li class="nav-item">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="<?php echo e(route('newreg')); ?> "><span class="nav-link-text">New Registration</span></a>
                                        </li>
                                        <li class="nav-item">
...
<!-- /Vertical Nav --><?php /**PATH C:\wamp64\www\Eldora\resources\views/inc/sidebar.blade.php ENDPATH**/ ?>