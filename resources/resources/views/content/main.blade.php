                            ...
                            <div class="card card-border mb-0 h-100">
                                <div class="card-header card-header-action">
                                    ...
                                    <div class="card-action-wrap">
                                        ...
                                        <a href="/studymaterial/uploadfiles" class="btn btn-sm btn-primary ms-3"><span><span class="icon"><span class="feather-icon"><i data-feather="plus"></i></span></span><span class="btn-text">Add new</span></span></a>
                                    </div>
                                </div>
                                <div class="card-body">
                                                    ...
                                                    <td>
                                                        <div class="media align-items-center">
                                                            ...
                                                            <div class="media-body">
                                                                <div class="text-high-em">Kartik Tyagi</div> 
